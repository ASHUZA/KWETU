              ...
              <div className="row">
                ...
                <div className="col-sm-6">
                  <ul class="list-group">
                    ...
                    <li class="list-item-detail">Constitution alimentaire: </li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                ...
                <div className="col-sm-6">
                  <ul class="list-group">
                    ...
                    <li class="list-item-detail">Rougeole dans la fratrie: </li>
                    <li class="list-item-detail">ATCD TBC dans la fratrie: </li>
...
export default KeshoChildDetail;
