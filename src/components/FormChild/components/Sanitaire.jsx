...
export class Sanitaire extends Component {
  continue = (e) => {
    e.preventDefault();
    this.props.nextStep();
  };
              ...
              <div className="form-group-main">
                <div className="form-group">
                  ...
                  <input
                    ...
                    name="nom"
                    onChange={inputChange("nom_pere")}
                    value={values.nom_pere}
                  />
                </div>
                <div className="form-group">
                  <label htmlFor="email">Prenom</label>
                  <input
                    ...
                    className="form-control"
                    name="prenom"
                    onChange={inputChange("prenom_pere")}
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    className="form-control"
                    name="phone"
                    onChange={inputChange("phone_pere")}
                    value={values.phone_pere}
                  />
                </div>
                <div className="form-group">
                  <label htmlFor="password">Sexe</label>
                  <input
                    ...
                    className="form-control"
                    name="sexe"
                    onChange={inputChange("sexe_pere")}
                    value={values.sexe_pere}
                  />
                </div>
